...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>radkod.com - Domain Sorgulama | Whois</title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="keywords" content="domain, Whois, domain sorgulama, domain sorgula, domain tescil, domain sorgu, domain arama, domain bul, domain kayıt, domain whois, domain ücretleri, domainler, online domain kayıt, domain seçimi, domain nedir" />
        <meta name="description" content="Domain, Whois sorgulama işlemlerinizi kolay ve basitce gerçekleştirebilirsiniz." />
        <meta name="googlebot" content="domain, Whois, domain sorgulama, domain sorgula, domain tescil, domain sorgu, domain arama, domain bul, domain kayıt, domain whois, domain ücretleri, domainler, online domain kayıt, domain seçimi, domain nedir" />
...
<center>
<table align="center">
<tr><td><img style="margin-top: 55px;margin-left: 1px;" src="./images/logo.png"></td><td>

<div class="reklam" style="
    margin-left: 234px;
">
...
<!-- afy alt menu-->
    ...
    margin-right: auto;
    border-radius: 4px;
    color: #5A5A5A;"><i class="fa fa-heart copy-kalp"></i><a href="https://www.radkod.com/" title="İzmir Web Tasarım" target="_blank">RadKod</a> Freelancer Ekibi Tarafından Sevgiyle Kodlanmıştır. © 2016 | Tüm Hakları Saklıdır.</p></center>
    </body>
</html>