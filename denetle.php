	...
	protected function domainkontrol(){
		...
		foreach ($this->domainBilgi as $key=>$value) {
			if(!empty($value['hata'])){
				...
				$domainAd = '<a href="http://www.'.$this->domain.'.'.$key.'" target="_blank">'.$this->domain.'.'.$key.'</a>';
				...
				$text2 = '<a target="_blank" href="https://www.radkod.com/iletisim?konu='.$this->domain.'.'.$key.' hakkında" target="_blank"><img src="./images/satinal.png" id="ters" alt="Satın Al" title="Satın Al"></a>';
				$class = "bos";
